          ...
          <div className="space-y-2">
            <div className="flex gap-2 flex-wrap">
              ...
              <Button
                ...
                size="sm"
                onClick={() => {
                  onSelectionChange(new Set(messages.map((_, i) => i).filter(i => messages[i].role === 'user')));
                  setMode('custom');
                }}
              >
                仅用户
              ...
              <Button
                ...
                size="sm"
                onClick={() => {
                  onSelectionChange(new Set(messages.map((_, i) => i).filter(i => messages[i].role === 'assistant')));
                  setMode('custom');
                }}
              >
                仅AI
            ...
            <ScrollArea className="h-48 border rounded-md p-2">
              <div className="space-y-1">
                {messages.map((msg, i) => {
                  if (roleFilter !== 'all' && msg.role !== roleFilter) return null;
                  return (
